...
![Load data with Julia](/assets/images/2022-03-31-from-python-to-julia-basic-data-manipulation-and-eda/load_data_julia.png "Load data with Julia")
...
![Load data with Python](/assets/images/2022-03-31-from-python-to-julia-basic-data-manipulation-and-eda/load_data_python.png "Load data with Python")
...
![Generate basic statistics with Julia](/assets/images/2022-03-31-from-python-to-julia-basic-data-manipulation-and-eda/basic_stats_julia.png "Generate basic statistics with Julia")
...
![Julia omits printing specified statistics](/assets/images/2022-03-31-from-python-to-julia-basic-data-manipulation-and-eda/stats_omitted_julia.png "Julia omits printing specified statistics")
...
![Check the class distribution with Julia](/assets/images/2022-03-31-from-python-to-julia-basic-data-manipulation-and-eda/class_distribution_julia.png "Check the class distribution with Julia")

In Python, we can achieve the same purpose by using the `value_counts()` function.

![Check the class distribution with Python](/assets/images/2022-03-31-from-python-to-julia-basic-data-manipulation-and-eda/class_distribution_python.png "Check the class distribution with Python")
...
![Plot distribution of transaction time and amount with Julia](/assets/images/2022-03-31-from-python-to-julia-basic-data-manipulation-and-eda/plot_trxn_time_amt_julia.png "Plot distribution of transaction time and amount with Julia")

In Python, we can use matplotlib and seaborn to create the same charts.

![Plot distribution of transaction time and amount with Python](/assets/images/2022-03-31-from-python-to-julia-basic-data-manipulation-and-eda/plot_trxn_time_amt_python.png "Plot distribution of transaction time and amount with Python")
...
![Downsampling in Julia](/assets/images/2022-03-31-from-python-to-julia-basic-data-manipulation-and-eda/downsampling_with_julia.png "Downsampling in Julia")
...
![Plot correlation matrix in Julia](/assets/images/2022-03-31-from-python-to-julia-basic-data-manipulation-and-eda/corr_matrix_with_julia.png "Plot correlation matrix in Julia")

Here’s the equivalent implementation of downsampling and plotting heatmap in Python.

![Plot correlation matrix in Python](/assets/images/2022-03-31-from-python-to-julia-basic-data-manipulation-and-eda/downsampling_and_corr_matrix_with_python.png "Plot correlation matrix in Python")
...
![Plot feature vs. class box plot in Julia](/assets/images/2022-03-31-from-python-to-julia-basic-data-manipulation-and-eda/feature_class_corr_plot_with_julia.png "Plot feature vs. class box plot in Julia")

The following code can be used to create the same boxplot in Python.

![Plot feature vs. class box plot in Python](/assets/images/2022-03-31-from-python-to-julia-basic-data-manipulation-and-eda/feature_class_corr_plot_with_python.png "Plot feature vs. class box plot in Python")
